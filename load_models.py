...
from models.wgan import (Generator, Discriminator, train_wgan_gp_, plot_gan_training)
from data.utils_data import GEFcomLoadLoader
...
dataset = pd.read_csv('data/load_data.csv')
...
train_dataloader, validation_dataloader, test_dataloader = train_loader.get_dataloaders(
                                                                batch_size=32, shuffle=True, use_gpu=True, test_size=0.5, validation_size=0.2,
...
plot_gan_training(gan_history, title='Καμπύλη Εκπαίδευσης του WGAN-GP στην Ζήτηση Ενέργειας', save_path='plots/GAN_LEARNING_CURVE_LOAD.png')
...
plot_correlations(generator, c_pred, train_loader.x_scaler, save_path='plots/GAN_CORRELATIONS_LOAD.jpg', title='Συσχετίσεις του WGAN-GP στην Ζήτηση Ενέργειας')
...
plot_vae_training(vae_history, title='Καμπύλη Εκπαίδευσης του VAE στην Ζήτηση Ενέργειας', save_path='plots/VAE_LOAD.jpg')
plot_load_forecasts(vae, prediction_loader, save_path='plots/VAE_FORECASTS_LOAD.jpg', filter_hours=filter_hours)
plot_correlations(vae, c_pred, train_loader.x_scaler, save_path='plots/VAE_CORRELATIONS_LOAD.jpg', title='Συσχετίσεις του VAE στην Ζήτηση Ενέργειας')
...
plot_nf_training(naf_history, title='Καμπύλη Εκπαίδευσης του NAF στην Ζήτηση Ενέργειας', save_path='plots/NAF_LEARNING_CURVE_LOAD.png')
plot_load_forecasts(naf, prediction_loader, save_path='plots/NAF_FORECASTS_LOAD.jpg', filter_hours=filter_hours)
plot_correlations(naf, c_pred, train_loader.x_scaler, save_path='plots/NAF_CORRELATIONS_LOAD.jpg', title='Συσχετίσεις του NAF στην Ζήτηση Ενέργειας')
...
plot_nf_training(nsf_history, title='Καμπύλη Εκπαίδευσης του NSF στην Ζήτηση Ενέργειας', save_path='plots/NSF_LEARNING_CURVE_LOAD.png')
plot_load_forecasts(nsf, prediction_loader, save_path='plots/NSF_FORECASTS_LOAD.jpg', filter_hours=filter_hours)
plot_correlations(nsf, c_pred, train_loader.x_scaler, save_path='plots/NSF_CORRELATIONS_LOAD.jpg', title='Συσχετίσεις του NSF στην Ζήτηση Ενέργειας')
...
plot_crps([gan_crps, vae_crps, naf_crps, nsf_crps], ['GAN', 'VAE', 'NAF', 'NSF'], save_path='plots/CRPS_LOAD.png', title='CRPS Μοντέλων στην Ζήτηση Ενέργειας')
plot_qs([gan_quantiles, vae_quantiles, naf_quantiles, nsf_quantiles], ['GAN', 'VAE', 'NAF', 'NSF'], save_path='plots/QS_LOAD.png', title='QS Μοντέλων στην Ζήτηση Ενέργειας')
...
plot_dm(losses, labels, h=1, save_path='plots/DM_TEST_LOAD.png', title='Έλεγχος Diebold-Mariano στην Ζήτηση Ενέργειας')
...
plot_roc_many_scenarios(X_real, fake_by_model, n_runs=50,
                        title="Καμπύλς ROC του Ταξινομητή στην Ζήτηση Ενέργειας", save_path='plots/ROC_LOAD.png')
