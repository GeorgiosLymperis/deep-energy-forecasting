...
evaluate_gan(generator, test_dataloader, "GAN_SOLAR", save_path='evaluations/GAN_EVALUATION.json', device=device)
plot_training(history, title='Learning curve (GAN)', save_path='plots/GAN_LEARNING_CURVE_SOLAR.png')
plot_forecasts(generator, prediction_loader, save_path='plots/GAN_FORECASTS_SOLAR.jpg')