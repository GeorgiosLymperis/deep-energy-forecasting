...
from data.utils_data import GEFcomSolarLoader, create_solar_dataset
...
train_dataset = dataset[dataset["TIMESTAMP"] < "2013-06-01 01:00:00"]
...
# ---- Studies ----
make_and_run_study("gan_study.db", "solar", gan_objective_, random_n=25, tpe_n=25)

make_and_run_study("vae_study.db", "solar", vae_objective_, random_n=25, tpe_n=25)

make_and_run_study("naf_study.db", "solar", naf_objective_, random_n=10, tpe_n=10)

make_and_run_study("nsf_study.db", "solar", nsf_objective_, random_n=10, tpe_n=15)
