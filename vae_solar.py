...
def plot_forecasts(generator, prediction_dataloader, save_path=None, **kwargs):
    ...
    active_hours = prediction_dataloader.active_hours
...
evaluate_vae(vae, test_dataloader, "VAE_SOLAR", save_path='evaluations/VAE_EVALUATION.json', device=device)
plot_training(history, title='Learning curve (VAE)', save_path='plots/VAE_SOLAR.jpg')
plot_forecasts(vae, prediction_loader, save_path='plots/VAE_FORECASTS_SOLAR.jpg')