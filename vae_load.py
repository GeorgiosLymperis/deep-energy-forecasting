...
def plot_forecasts(vae, prediction_dataloader, save_path=None, **kwargs):
...
with open('draft.txt', 'w') as f:
    f.write(str(prediction_dataset.columns))
...
plot_training(history, title='Learning curve (VAE)', save_path='plots/VAE_LOAD.jpg')
evaluate_vae(vae, test_dataloader, "VAE_LOAD", save_path='evaluations/VAE_EVALUATION.json', device=device)
plot_forecasts(vae, prediction_loader, save_path='plots/VAE_FORECASTS_LOAD.jpg')